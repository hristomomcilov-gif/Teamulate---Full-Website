...
import { SOCIAL_PROFILES, type SocialProfileName } from "@/lib/site";

const ICON_CLASS = "h-5 w-5";

function XIcon() {
  return (
    <svg viewBox="0 0 24 24" className={ICON_CLASS} aria-hidden fill="currentColor">
...
function TikTokIcon() {
  return (
    <svg viewBox="0 0 24 24" className={ICON_CLASS} aria-hidden fill="currentColor">
      <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.77.14 2.89 2.89 0 0 1 2.89-2.89c.3 0 .59.04.87.13V9.01a6.34 6.34 0 1 0 5.47 6.27V8.75a8.18 8.18 0 0 0 4.77 1.52V6.83a4.85 4.85 0 0 1-1.01-.14z" />
    </svg>
  );
}
...
const ICONS: Record<SocialProfileName, () => JSX.Element> = {
  X: XIcon,
