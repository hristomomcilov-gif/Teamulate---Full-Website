 ...
 *
 * 8 Sep (Chris): the top-level "Team" link became an "About" dropdown with
 * exactly two children — "Chris" (/about-chris/) and "The Team" (/team/).
 * Team must not appear as its own top-level item.
 */
